...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    StudentInfoDto studentInfoDtos = new StudentInfoDto("존도", 21, "서울시 노원구");
    studentService.saveStudent(studentInfoDto);
    studentService.saveStudent(studentInfoDtos);

    CourseInfoDto courseInfoDto = new CourseInfoDto("바이올린", 1000, "MONDAY", "홍길동", 1717299008L);
    CourseInfoDto courseInfoDtos = new CourseInfoDto("첼로", 1200, "MONDAY", "존도", 1717299008L);
    courseService.registerCourse(courseInfoDto);
    courseService.registerCourse(courseInfoDtos);
